...
public class ArticlePage {
    ...
    @FXML
    private Button article1Button;

    @FXML
    private Button article2Button;

    @FXML
    private Button article3Button;

    @FXML
    private Button article4Button;
    ...
    @FXML
    public void Article1Page(ActionEvent event) throws IOException{
    ...
    @FXML
    public void Article2Page(ActionEvent event) throws IOException{
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Article.fxml"));
        root = loader.load();
        stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
    ...
    @FXML
    public void Article3Page(ActionEvent event) throws IOException{
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Article.fxml"));
        root = loader.load();
        stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
    ...
    @FXML
    public void Article4Page(ActionEvent event) throws IOException{
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Article.fxml"));
        root = loader.load();
        stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
